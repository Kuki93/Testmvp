package com.example.helpme.library.util;
...
public class AppScreenUtils {
    ...
    public static int getNavigationAreaHeight(Context context) {
        int realScreenHeight = AppScreenUtils.getRealScreenHeight(context);
        int screenHeight = AppScreenUtils.getScreenHeight(context);
    ...
    public static String shoot(Activity a) {
        ...
        boolean ret = AppScreenUtils.savePic(AppScreenUtils.takeScreenShot(a), localPath);
        if (ret) {
            return localPath;
        } else {
            return "";
    ...
    public static String shootWebView(Context context, WebView webView) {
        ...
        boolean ret = AppScreenUtils.savePic(AppScreenUtils.captureWebView(webView), localPath);
        if (ret) {
            return localPath;
        } else {
            return "";
