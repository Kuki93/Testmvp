 ...
 */
public abstract class BaseMvpAppCompatActivity<V extends BaseMvpView, P extends BaseMvpPresenter<V>>
        extends BaseAppCompatActivity implements PresenterProxyInterface<V, P> {
