...
public class PresenterMvpFactoryImpl<V extends BaseMvpView, P extends BaseMvpPresenter<V>>
    ...
    @Override
    public P createMvpPresenter(Context context, V v) {
        try {
            Constructor<P> constructor = mPresenterClass.getDeclaredConstructor(Context.class, BaseMvpView.class);
            return constructor.newInstance(context, v);
        } catch (Exception e) {
